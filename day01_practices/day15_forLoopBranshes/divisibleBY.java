...
public class divisibleBY {
    public static void main(String[] args) {
        ...
        String DivisiblelBy15 = "";
        String DivisiblelBy3 = "";
        String DivisiblelBy5 = "";
        for (int i = 1; i < 101; i++) {
            if(i % 15 == 0){
                DivisiblelBy15 += i;
            }
        ...
        System.out.print("Divisible by 15: " + DivisiblelBy15 );
        System.out.println();
        System.out.print(" Divisible by 5: " + DivisiblelBy5 );
        System.out.println();
        System.out.print( "Divisible by 3: " + DivisiblelBy3);
