...
public class CydeoStudents {
    public static void main(String[] args) {
        ...
        String[][] batch1Groups = {{"Ahmet", "Baturay", "Beyza", "Dilara", "Muhtar"}, {"Entisar", "Ermek", "Esmira", "Gadir", "Hrvoje", "Igor", "Muhtar"}, {"Kramer", "Lorraine", "Lucy", "Madina", "Yasin", "Muhtar"} };
        ...
        String[][] batch2Groups = {{"Fuat", "Kenann", "Aliya", "Anna", "Murodil"}, {"Layla", "Oksana", "Tyler", "Murodil"}, {"Chris", "Yurii", "Mubarek", "Erika", "Subi", "Nadiia", "Murodil"}};

        String[][][] CydeoStudents = {{{"Ahmet", "Baturay", "Beyza", "Dilara", "Muhtar"}, {"Entisar", "Ermek", "Esmira", "Gadir", "Hrvoje", "Igor", "Muhtar"}, {"Kramer", "Lorraine", "Lucy", "Madina", "Yasin", "Muhtar"} },  {{"Fuat", "Kenann", "Aliya", "Anna", "Murodil"}, {"Layla", "Oksana", "Tyler", "Murodil"}, {"Chris", "Yurii", "Mubarek", "Erika", "Subi", "Nadiia", "Murodil"}}};
